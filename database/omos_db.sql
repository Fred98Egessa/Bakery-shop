...
INSERT INTO `product_list` (`id`, `category_id`, `brand`, `name`, `description`, `quantity`, `price`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
